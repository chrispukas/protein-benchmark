...
import incito_pipeline.util.io.json as json_p
...
def create_negative_control_dataset_replace_single(path_to_pdb: str, 
    ...
    df = csv_e.reformat_db(cd.read_parquet(path_to_id_dataset), seq_columns=seq_columns)
    df_full = cd.read_csv(path_to_dataset)
