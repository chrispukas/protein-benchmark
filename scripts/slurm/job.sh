...
#### FOR EXAMPLE
time boltz predict /home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/FASTAS/ --out_dir /home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/BOLTZ_OUT/ \
--cache "$BOLTZ_CACHE" \
 --use_msa_server --override \
 --diffusion_samples 10 \
 --max_parallel_samples 5 --preprocessing-threads 8 \
