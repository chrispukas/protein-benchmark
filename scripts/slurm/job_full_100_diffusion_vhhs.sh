...
#### FOR EXAMPLE
time boltz predict "/home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/ful_full/vhhs/fastas_vhhs" \
 --out_dir "/home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/run_full/vhhs/boltz_output_vhhs" \
 --cache "$BOLTZ_CACHE" \
