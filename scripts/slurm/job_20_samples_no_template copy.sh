...
#### FOR EXAMPLE
time boltz predict /home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/sample_run_20/sample_fastas --out_dir /home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/sample_run_20/boltz_output \
--cache "$BOLTZ_CACHE" \
