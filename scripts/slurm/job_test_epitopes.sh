...
#### FOR EXAMPLE
time boltz predict /home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/epitope_docking_test/yaml \
--out_dir /home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/epitope_docking_test/boltz_out \
--cache "$BOLTZ_CACHE" \
 --use_msa_server --override \
 --diffusion_samples 1 \
 --max_parallel_samples 2 --preprocessing-threads 4 \
