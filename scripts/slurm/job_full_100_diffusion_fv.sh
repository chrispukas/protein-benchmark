...
#### FOR EXAMPLE
time boltz predict "/home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/ful_full/fv/fastas_fv" \
 --out_dir "/home/${USER_NAME}/repos/incito-pipeline/incito_pipeline/datasets/out/run_full/fv/boltz_output_fv" \
 --cache "$BOLTZ_CACHE" \
